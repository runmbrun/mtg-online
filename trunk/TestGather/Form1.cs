...
namespace TestMTGGatherer
{
    public partial class Form1 : Form
    {
        ...
        // temporary storage
        public static MTGCardSet TempSet;
        ...
        public Form1()
        {
            ...
            //comboBoxInstrument.Items.Add("White");
        ...
        {            
            ...
            try
            {
                ...
                TempSet = (MTGCardSet)bformatter.Deserialize(stream);
                stream.Close();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void buttonCreatePicturePack_Click(object sender, EventArgs e)
        {
            SaveFileDialog save = new SaveFileDialog();
            ...
            if (save.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    // Attempt to save all pictures in the current cardset to a "picture pack"
                    if (TempSet != null && TempSet.CardSet.Count > 0)
                    {
                        MTGPicturePack pack = new MTGPicturePack();

                        // go through all the pictures
                        foreach (MTGCard card in TempSet.CardSet)
                        {
                            pack.Add(card.ID, card.Pic);
                        }
 ...
 * Fix the Property.Settings.Default issue - why doesn't it like Properties any more?  Something with renaming namespace
 * */
